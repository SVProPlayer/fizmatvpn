...
SUBSCRIPTIONS = {
    ...
    "kustvpn.txt": [
        ("LTE4_EU", "🇪🇺[🛡️] 🟠МегаФон,МТС,Т2"),
        ("LTE4_RU", "🇷🇺[🛡️] 🟠МегаФон,МТС,Т2"),
        ("LTE1_EU", "🇪🇺[🛡️] 🔵МегаФон,МТС,Т2"),
        ("LTE1_RU", "🇷🇺[🛡️] 🔵МегаФон,МТС,Т2"),
        ("LTE3_EU", "🇪🇺[🛡️] 🟣МегаФон,МТС,Т2"),
        ("LTE3_RU", "🇷🇺[🛡️] 🟣МегаФон,МТС,Т2"),
        ("LTE2_EU", "🇪🇺[🛡️] ⚪МегаФон,МТС,Т2"),
        ("LTE2_RU", "🇷🇺[🛡️] ⚪МегаФон,МТС,Т2"),
        ("Poland", "🇵🇱[🛡️] 🛜Poland ⭐"),
        ("Finland", "🇫🇮[🛡️] 🛜Finland"),
        ("Germany", "🇩🇪[🛡️] 🛜Germany"),
        ("Italy", "🇮🇹[🛡️] 🛜Italy"),
        ("France", "🇫🇷[🛡️] 🛜France"),
        ("NL_1", "🇳🇱[🛡️] 🛜Netherlands №1"),
        ("NL_2", "🇳🇱[🛡️] 🛜Netherlands №2 ⭐"),
        ("NL_3", "🇳🇱[🛡️] 🛜Netherlands №3"),
        ("Hungary", "🇭🇺[🛡️] 🛜Hungary"),
        ("Czech", "🇨🇿[🛡️] 🛜Czech.Rep"),
        ("SPB", "🇷🇺[🛡️] 🛜St.Petersburg 🕊️⭐"),
        ("Moscow_1", "🇷🇺[🛡️] 🛜Moscow №1 🕊️"),
        ("Moscow_2", "🇷🇺[🛡️] 🛜Moscow №2 🕊️"),
        ("USA", "🇺🇸[🛡️] 🛜USA"),
    ],
    "user_ivan.txt": [
        ("LTE4_EU", "🇪🇺🟠МегаФон №1"),
